...
public class TelaMenuAlunoEscrever extends JDialog {
	...
	public TelaMenuAlunoEscrever(ControllerMusica musica, Usuario user) {
		 maux = musica;
		 userx=user;
         ...
         try {	
    			...
    			musica11 = new ControllerMusica("C:\\SAI\\audio\\voice\\comecopalavras.mp3");
    			musica11.play();
         ...
         btnComecar.addActionListener (new ActionListener() {
             public void actionPerformed(ActionEvent e) {
                ...
                new TelaEscrever(userx);

             }
         });
         
     
         ImageIcon Image = new ImageIcon("C://sai//img//BackgroundTelaEscrever.png");

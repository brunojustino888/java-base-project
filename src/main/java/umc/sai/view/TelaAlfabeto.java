...
public class TelaAlfabeto extends JDialog {
	...
	private static ViewPainelAlfabeto painel;
	private Usuario userx;

	
	public TelaAlfabeto(Usuario user) {
         ...
         painel = new ViewPainelAlfabeto(this, userx); 
         painel.setBounds(new Rectangle(297, 226, 206,148));

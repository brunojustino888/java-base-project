...
* @version 1.0
*/
public class SextaFeira extends JFrame {
	...
	LabelCod = new JLabel("Cod:");
     ...
     ButtonAlterar.addActionListener (new ActionListener() {
         public void actionPerformed(ActionEvent e) {
        	 ...
        	 Conexao a = new Conexao();
		        ...
		        try {		        	
		             a.executarComando("update Agenda set Nome = '"+nome+"' "+"where ID = "+id);
     ...
     ButtonConsultar.addActionListener (new ActionListener() {
         public void actionPerformed(ActionEvent e) {
        	 ...
        	 String nomedaconsulta = JTextFieldNome.getText();
        	 Conexao a = new Conexao();
		        
		        try {		        	
		        	
		        	ResultSet rs = a.executarConsulta("Select * from Agenda where Nome = '"+nomedaconsulta+"' ");

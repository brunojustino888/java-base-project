...
public class TelaProfessorAtividadesConsulta extends JDialog {
    ...
    public TelaProfessorAtividadesConsulta(Usuario user) {
        ...
        ArrayList<String> array = c.returnAtividades();
        ...
        btnVisualizar.addActionListener (new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	...
            	new TelaProfessorAtividadesConsultaVisualizar(userx,selecionado);
            }
        });
        
        ImageIcon Image = new ImageIcon("C:\\SAI\\img\\BackgroundInicioProfessorAtividadeConsultaTodas.png");

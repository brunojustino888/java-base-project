...
public class TelaMenuAlunoVogais extends JDialog {
	...
	public TelaMenuAlunoVogais(ControllerMusica musica, Usuario user) {
		 maux = musica;
		 userx=user;
         ...
         try {	
    			...
    			musica11 = new ControllerMusica("C:\\SAI\\audio\\voice\\comecovogais.mp3");
    			musica11.play();
         ...
         ImageIcon Image = new ImageIcon("C://sai//img//BackgroundTelaVogais.png");

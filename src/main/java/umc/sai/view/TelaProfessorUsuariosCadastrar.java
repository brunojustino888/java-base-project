...
public class TelaProfessorUsuariosCadastrar extends JDialog {
    ...
    public TelaProfessorUsuariosCadastrar(Usuario user) {
        ...
        btnUsuariosC.addActionListener (new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if(validarCampos()){
                	...
                	new ControllerConexaoDB().InsertUser(usuarioCadastro);
                	setVisible(false);
        ...
        ImageIcon Image = new ImageIcon("C:\\SAI\\img\\BackgroundInicioProfessorUsuariosCadastrar.png");

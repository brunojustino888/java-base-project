...
public class TelaProfessorAtividadesConsultarByAlunoVisualizarII extends JDialog {
    ...
    public TelaProfessorAtividadesConsultarByAlunoVisualizarII(Usuario user, String jcbselecionado) {
    	aux = jcbselecionado;

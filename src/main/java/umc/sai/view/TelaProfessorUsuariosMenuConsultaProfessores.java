...
public class TelaProfessorUsuariosMenuConsultaProfessores extends JDialog {
    ...
    public TelaProfessorUsuariosMenuConsultaProfessores(Usuario user) {
        ...
        ArrayList<String> array = c.returnProfessores();
        ...
        ImageIcon Image = new ImageIcon("C:\\SAI\\img\\BackgroundInicioProfessorUsuariosMenuConsultaProfessor.png");

...
public class TelaProfessorUsuarios extends JDialog {

	//Dados dos Objetos da Janela
	private static final long serialVersionUID = 1L;
	private JLabel  lblImageBackground;
	private JButton btnSair,btnUsuariosC, btnUsuariosConsulta;
	private ControllerFonte fonte;
	private Usuario userx;
	
	
    public TelaProfessorUsuarios(Usuario user) {
        ...
        ImageIcon Image = new ImageIcon("C:\\SAI\\img\\BackgroundInicioProfessorUsuarios.png");

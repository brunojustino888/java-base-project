...
public class TelaProfessorUsuariosMenuConsultaTudo extends JDialog {
    ...
    public TelaProfessorUsuariosMenuConsultaTudo(Usuario user) {
        ...
        ArrayList<String> array = c.returnUsers();
        ...
        ImageIcon Image = new ImageIcon("C:\\SAI\\img\\BackgroundInicioProfessorUsuariosMenuConsultaTudo.png");

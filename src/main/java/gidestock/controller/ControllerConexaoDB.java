...
public class ControllerConexaoDB {
	...
	public Object[][] returnPalavras(int i){
...
//		}
	...
	public void InsertProduto(String nome,int quantidade,String preco,int estoquemin,String descricao){
		String comando = "insert into produtos (nome, quantidade, preco, estoque_min, descricao) values('"+nome+"',"+quantidade+",'"+preco+"',"+estoquemin+",'"+descricao+"');";

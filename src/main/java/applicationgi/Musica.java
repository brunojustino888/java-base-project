...
/**Musica:
 * Essa � a classe utilizada para tocar m�sica. 
 * Classe muito complexa que dispensa explica��es.
 * @author Bruno Alves Justino
 * @date � Mar�o - 2014
 */
public class Musica {
	
	private String musicaString;
	...
	public Musica(String path) throws UnsupportedAudioFileException, IOException,LineUnavailableException {
		...
		this.musicaString = path;
		musicFile = new File(musicaString);
		create();
	 ...
	 */
	private void create() throws UnsupportedAudioFileException, IOException,LineUnavailableException {
	...
	public String getNomeMusica() throws UnsupportedAudioFileException,
		...
		Map<String, Object> propriedade = ((TAudioFileFormat) baseFileFormat)
				.properties();
	...
	public String getExtensao() {
		...
		for (int i = (musicaString.length() - 3); i < musicaString.length(); i++) {
			sb.append(musicaString.charAt(i));
		}
	...
	public void setMusica(String musica) {
		this.musicaString = musica;
		musicFile = new File(this.musicaString);
	}
}

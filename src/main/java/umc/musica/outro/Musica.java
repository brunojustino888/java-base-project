...
public class Musica {
	...
	public Musica() throws UnsupportedAudioFileException, IOException,LineUnavailableException {
		// Get music file name
		//this.music =  D:\Music\Trance\DJ P4blu - Groovy On [Intense].mp3
		this.musica = javax.swing.JOptionPane.showInputDialog("Endere�o da M�sica:");
